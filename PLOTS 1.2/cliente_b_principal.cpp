...
void Cliente_B_Principal::vaciar(){
...
void Cliente_B_Principal::CargarLugares(int id, QString calendario, QString reloj){
...
void Cliente_B_Principal::VerReservaciones(int id){
...
void Cliente_B_Principal::on_Cancel_ReservapushButton_clicked()
{
...
void Cliente_B_Principal::on_Reserva_pushButton_clicked()
{
    ui->Ventanas->setCurrentIndex(0);
}

void Cliente_B_Principal::on_MisReservas_pushButton_clicked()
{
    ui->Mis_rservas_tableWidget->clear();
    ui->Mis_rservas_tableWidget->setRowCount(0);
    QStringList titulos;
...
void Cliente_B_Principal::on_Contrato_pushButton_clicked()
{
...
void Cliente_B_Principal::on_L_2pushButton_clicked()
{
    idCajon = 2;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_3pushButton_clicked()
{
    idCajon = 3;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_4pushButton_clicked()
{
    idCajon = 4;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_5pushButton_clicked()
{
    idCajon = 5;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_6pushButton_clicked()
{
    idCajon = 6;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_7pushButton_clicked()
{
    idCajon = 7;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_8pushButton_clicked()
{
    idCajon = 8;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_9pushButton_clicked()
{
    idCajon = 9;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_L_10pushButton_clicked()
{
    idCajon = 10;
    idPiso = 2;
    ui->calendarWidget->setSelectedDate(ui->calendarWidget_2->selectedDate());
...
void Cliente_B_Principal::on_Nueva_Reserva_pushButton_clicked()
{
    ui->Ventanas->setCurrentIndex(0);
}

void Cliente_B_Principal::on_Nivel3_pushButton_clicked()
{
    ui->Ventanas->setCurrentIndex(1);
}

void Cliente_B_Principal::on_Nivel2_pushButton_3_clicked()
{
    ui->Ventanas->setCurrentIndex(0);
}

void Cliente_B_Principal::on_LL_1pushButton_3_clicked()
{
    idCajon = 1;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_2pushButton_3_clicked()
{
    idCajon = 2;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_3pushButton_3_clicked()
{
    idCajon = 3;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_4pushButton_3_clicked()
{
    idCajon = 4;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_5pushButton_3_clicked()
{
    idCajon = 5;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_6pushButton_3_clicked()
{
    idCajon = 6;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_7pushButton_3_clicked()
{
    idCajon = 7;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_8pushButton_3_clicked()
{
    idCajon = 8;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_L_9pushButton_3_clicked()
{
    idCajon = 9;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_LL_10pushButton_3_clicked()
{
    idCajon = 10;
    idPiso = 3;
    ui->Ventanas->setCurrentIndex(2);
...
void Cliente_B_Principal::on_calendarWidget_2_selectionChanged()
{
...
void Cliente_B_Principal::on_H_llegadatimeEdit_2_timeChanged(const QTime &time)
{
...
void Cliente_B_Principal::on_Confirma_Reserva_pushButton_clicked()
{
